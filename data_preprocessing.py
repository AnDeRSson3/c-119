...
def create_bot_corpus(stem_words, classes, pattern_word_tags_list):
    # sort the stem_words list and classes list
    stem_words = sorted(list(set(stem_words)))
    classes = sorted(list(set(classes)))
    pattern_word_tags = sorted(list(set(pattern_word_tags_list)))
    pickle.dump(stem_words, open('words.pkl','wb'))
    pickle.dump(classes, open('classes.pkl','wb'))
    pickle.dump(pattern_word_tags_list,open("pattern_word_tags_list.pkl","wb"))
    # print stem_words
...
# Tags-----------> as Label
stem_words, classes, pattern_word_tags_list=create_bot_corpus(stem_words, classes, pattern_word_tags_list)
def bag_of_words_encoding(stem_words, pattern_word_tags_list):
    ...
    for word_tags in pattern_word_tags_list:
        ...
        stem_words = get_stem_words(pattern_words, ignore_words)
